...
class InternshipPlacement(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['student', 'start_date'], name='unique_placement_date')
        ]
...
class WeeklyLog(models.Model):
    ...
    # The fix for the migration blockade
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['placement', 'week_number'], name='unique_week_per_placement')
        ]
